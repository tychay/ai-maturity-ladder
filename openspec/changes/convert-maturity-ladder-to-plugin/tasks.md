...
- [x] 5.1 Move submodule from `ai/maturity-ladder` to `.claude/skills/aiml/`
...
- [ ] 6.2 Verify `/aiml:graduation-suggest` is discoverable and invocable after install
- [ ] 6.3 Run `/aiml:setup` and confirm it correctly detects CLAUDE.md and proposes the right reference line
